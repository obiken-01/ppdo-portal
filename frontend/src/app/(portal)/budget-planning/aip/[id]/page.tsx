...
export default function AipDetailPage({ params }: { params: { id: string } }) {
  ...
  // Aggregate counts for the subtitle
    ...
    <div className="p-6 max-w-screen-2xl mx-auto">
      ...
      <div className="overflow-x-auto border border-slate-200 shadow-sm">
        <table className="min-w-[1800px] w-full border-collapse text-sm">
          {/* Column group for proportional widths */}
          <colgroup>
            <col style={{ width: "140px" }} /> {/* Ref Code */}
            <col style={{ width: "300px" }} /> {/* Description */}
            <col style={{ width: "56px"  }} /> {/* eSRE */}
            <col style={{ width: "110px" }} /> {/* Implementing Office */}
            <col style={{ width: "72px"  }} /> {/* Start */}
            <col style={{ width: "72px"  }} /> {/* End */}
            <col style={{ width: "200px" }} /> {/* Expected Outputs */}
            <col style={{ width: "90px"  }} /> {/* Funding */}
            <col style={{ width: "90px"  }} /> {/* PS */}
            <col style={{ width: "90px"  }} /> {/* MOOE */}
            <col style={{ width: "90px"  }} /> {/* CO */}
            <col style={{ width: "100px" }} /> {/* Total */}
            <col style={{ width: "80px"  }} /> {/* CC Adapt */}
            <col style={{ width: "80px"  }} /> {/* CC Mitig */}
            <col style={{ width: "70px"  }} /> {/* CC Code */}
          </colgroup>

          <thead>
            {/* Top header row — grouped labels */}
