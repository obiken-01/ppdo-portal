...
const OVERRIDE_KEYS: {
  ...
  { key: "overrideCanAccessBudgetPlanning", label: "Access Investment Planning" },
  ...
  { key: "overrideCanManageOfficeCeilings",         label: "Set Office Ceilings (PPDO finance)", adminOnly: true },
...
export default function UsersPage() {
  ...
  function openEdit(user: UserResponse) {
    ...
    setEditForm({
      ...
      overrideCanManageOfficeCeilings:         user.overrideCanManageOfficeCeilings,
