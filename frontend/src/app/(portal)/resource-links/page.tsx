...
function LinkFormModal({
  ...
  return (
    ...
    >
      <div className="bg-white shadow-xl border border-slate-200 w-full max-w-md" onClick={(e) => e.stopPropagation()}>
...
function ConfirmDeleteModal({
  ...
  return (
    <div
      ...
      onClick={onClose}
    >
      <div className="bg-white shadow-xl border border-slate-200 w-full max-w-sm p-6" onClick={(e) => e.stopPropagation()}>
